...
class ToolTip(QWidget):
    ...
    def _setup_show_animation(self):
        ...
        self._pos_animation.setEndValue(
            self._position - QPoint(self.sizeHint().width() // 2, 0)
        )
    ...
    def _setup_hide_animation(self):
        ...
        self._hide_connection: QMetaObject.Connection = (
            self._width_animation.finished.connect(self.hide)
        )
