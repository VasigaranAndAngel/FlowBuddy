...
class SettingsUI(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.window_toggle_signal.connect(
    ...
    def _create_setting(
        self, group_name: str, setting_name: str, options: dict[str, Any]
    ) -> None:
        ...
        def set_setting_value(
            *_, setting_name: str = setting_key, value: Any = None
        ) -> None:
            with contextlib.suppress(Data.NotFoundException):
        ...
        def reset_setting_value(
            *_, setting_name: str = setting_key, widget: QSpinBox = None
        ) -> None:
            with contextlib.suppress(Data.NotFoundException):
        ...
        if setting_type == ENTRY:
            ...
            spinbox.setValue(
                value if (value := get_setting_value()) is not None else UI_SCALE
            )
